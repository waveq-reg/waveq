...
def get_parser(desc, default_task="translation"):
    ...
    parser.add_argument('--waveq_num_bits_quantize', type=int,default=8,help='bitwidth for quantization')
    parser.add_argument('--waveq_lambda_q_mode', type=str,default='static')
    parser.add_argument('--waveq_lambda_param_r', type=float,default=1.0)
    parser.add_argument('--waveq_lambda_param_s', type=int,default=7)
    parser.add_argument('--waveq_lambda_param_q0', type=float,default=5.0)
    parser.add_argument('--waveq_max_normalization', type=str,default='static')
